...
for k in ANTHROPIC_API_KEY CLAUDE_API_KEY GEMINI_API_KEY GOOGLE_API_KEY DEEPSEEK_API_KEY MOONSHOT_API_KEY KIMI_API_KEY PERPLEXITY_API_KEY CLERK_SECRET_KEY CLERK_PUBLISHABLE_KEY STRIPE_SECRET_KEY STRIPE_WEBHOOK_SECRET SUPABASE_URL SUPABASE_SECRET_KEY ENCRYPTION_KEY PLAUSIBLE_API_KEY SENTRY_DSN AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY R2_ACCOUNT_ID SUBSTRATE_INGEST_SECRET OPENROUTER_API_KEY; do
