...
#   and bind, the two Ollama model tags, Textract monthly cap.
...
ask MODEL_A          "Ollama model for drafting and checks" "qwen2.5:1.5b"
ask MODEL_B          "Ollama model for Compare's second column" "llama3.2:1b"
