...
| 2026-09-05 | Settings overlay + nav fix | uncommitted | pass (Cursor) | Fix undefined `FULL_VIEWS` crash in `app_nav.js`. Settings opens as overlay (`#settings-overlay`) — workbench stays visible. `openSettings` / `closeSettings`, Escape + backdrop close. UI cache `assure-90`/`assure-85`. |
